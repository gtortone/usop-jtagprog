...
#define JTAG_TCK ((PIN){   "GPIO1_13",    GPIO1,     45, 	13,	 "gpmc_ad13",       29,    FALSE, 0   })
#define JTAG_TDI ((PIN){   "GPIO1_12",    GPIO1,     44, 	12,	 "gpmc_ad12",       28,    FALSE, 0   })
...
#define JTAG_TMS ((PIN){   "GPIO1_15",    GPIO1,     47, 	15,	 "gpmc_ad15",       31,    FALSE, 0   })
#define JTAG_TDO ((PIN){   "GPIO1_14",    GPIO1,     46, 	14,	 "gpmc_ad14",       30,    FALSE, 0   })
